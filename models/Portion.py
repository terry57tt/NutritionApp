...
class Portion(db.Model):
    ...
    label_portion = db.Column(db.Integer, nullable=False,
                              server_default='0')  # 1=matin, 2=collation matin, 3=midi, 4=collation aprem, 5=soir, 6=collation soir
    ...
    def get_unite_display(self):
        unit_display_map = {
            1: 'u',
            2: 'mL',
        }

        # default unit is gram if not in map
        return unit_display_map.get(self.aliment_obj.unite, 'g')
